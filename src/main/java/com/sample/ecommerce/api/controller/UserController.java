...
import com.sample.ecommerce.domain.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<List<AccountResponse>> get() {
        List<AccountResponse> result = _userService.getAll().stream().map(c -> {
    ...
    public ResponseEntity<AccountResponse> add(@RequestBody AccountRequest model) throws ElementExistedException {
        ...
        accountDto = _userService.addNew(accountDto);
    ...
    @ResponseBody
    public ResponseEntity<AccountResponse> confirmAccount(@PathVariable("userName") String userName) {
        _userService.confirmation(userName);
